...
using RoadBook.CsharpBasic.Chapter11.Model;
...
namespace RoadBook.CsharpBasic.Chapter11
{
    public partial class Form1 : Form
    {
        ...
        private void BtnMenu_Click(object sender, EventArgs e)
        {
            ...
            listBox1.Items.Add(lstMenu.Find(m => m.Id == 
            Convert.ToInt32(clickedButton.Tag)).Name);
        }
        ...
        private void BtnPayment_Click(object sender, EventArgs e)
        {
            ...
            lblPaymentInfo.Text = string.Format("총 결제금액: {0}", total);
        }
    }
}
